export default function HomePage(props) {
    ...
    return (
        <div>
            <div className="mb-20">
                <h1 className="text-5xl font-bold mb-2">Welcome to UrbanBus (Adnim Page?)</h1>
                <p className="text-2xl">Choose any option</p>
            </div>
            
            <div className="flex flex-wrap gap-12 justify-evenly">
                <button className="card card-bordered w-96 bg-base-100 shadow-xl" onClick={props.showStops}>
                ...
                <button className="card card-bordered w-96 bg-base-100 shadow-xl" onClick={props.showClients}>
                    <div className="card-body flex flex-row gap-7">
                        <svg className="size-16 my-auto mx-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                            <path fill='#333c4d' d="M144 0a80 80 0 1 1 0 160A80 80 0 1 1 144 0zM512 0a80 80 0 1 1 0 160A80 80 0 1 1 512 0zM0 298.7C0 239.8 47.8 192 106.7 192h42.7c15.9 0 31 3.5 44.6 9.7c-1.3 7.2-1.9 14.7-1.9 22.3c0 38.2 16.8 72.5 43.3 96c-.2 0-.4 0-.7 0H21.3C9.6 320 0 310.4 0 298.7zM405.3 320c-.2 0-.4 0-.7 0c26.6-23.5 43.3-57.8 43.3-96c0-7.6-.7-15-1.9-22.3c13.6-6.3 28.7-9.7 44.6-9.7h42.7C592.2 192 640 239.8 640 298.7c0 11.8-9.6 21.3-21.3 21.3H405.3zM224 224a96 96 0 1 1 192 0 96 96 0 1 1 -192 0zM128 485.3C128 411.7 187.7 352 261.3 352H378.7C452.3 352 512 411.7 512 485.3c0 14.7-11.9 26.7-26.7 26.7H154.7c-14.7 0-26.7-11.9-26.7-26.7z"/>
                        </svg>
                        <div className="my-auto">
                ...
                <button className="card card-bordered w-96 bg-base-100 shadow-xl" onClick={props.showValidations}>
                    <div className="card-body">
                        <h2 className="card-title">Validations</h2>
                        <p>X Client Accounts</p>
                    </div>
                </button>
            </div>
        </div>
