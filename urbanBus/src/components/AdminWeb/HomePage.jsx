    ...
    return (
        <div>
            ...
            <div className="flex flex-wrap gap-12 justify-evenly pb-12">
                <button className="card card-bordered w-96 bg-base-100 shadow-xl" onClick={() => setCurrentPage('Stops')} >
                ...
                <button className="card card-bordered w-96 bg-base-100 shadow-xl" onClick={() => setCurrentPage('Lines')}>
                    <div className="card-body flex flex-row gap-7">
                ...
                <button className="card card-bordered w-96 bg-base-100 shadow-xl" onClick={() => setCurrentPage('Tickets')}>
                    <div className="card-body flex flex-row gap-7">
                ...
                <button className="card card-bordered w-96 bg-base-100 shadow-xl" onClick={() => setCurrentPage('Clients')}>
                    <div className="card-body flex flex-row gap-7">
                ...
                <button className="card card-bordered w-96 bg-base-100 shadow-xl" onClick={() => setCurrentPage('Validations')}>
