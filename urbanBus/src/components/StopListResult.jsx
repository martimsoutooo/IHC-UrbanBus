...
export default function StopListResult(props) {
	...
	const journeys = lastStop != "" ? [
		...
		{line: 'L3', firstStop: {name: 'Tanques de Esgueira', lat: -23.550520, lon: -46.633308}, lastStop: {name: 'Rua de Ovar', lat: -23.550520, lon: -46.633308}, startTime: '22:28', endTime: '22:51'},u	
